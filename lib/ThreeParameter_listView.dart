...
class ThreeParameterListView extends StatefulWidget {
  const ThreeParameterListView({super.key});

  @override
  State<ThreeParameterListView> createState() => _ThreeParameterListViewState();
}

class _ThreeParameterListViewState extends State<ThreeParameterListView> {
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                ...
                if (name.isNotEmpty && email.isNotEmpty && phone.isNotEmpty) {
                  _editEntry(index, Entry(name: name, email: email, phone: phone));
                  Navigator.of(context).pop();
                }
              },
              child: Text("Save"),
